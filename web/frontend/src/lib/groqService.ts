import { GroqZoneDensity, GroqPrediction, GroqSuggestion, GroqDecision } from './store'
...
export async function generateDecisions(suggestions: GroqSuggestion[], densityData: GroqZoneDensity[]): Promise<{ decisions: GroqDecision[] }> {
